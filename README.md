...
1. **BIG FEATURE**: OpenCode-alike UI (props to [`pi-zentui`](https://github.com/lmilojevicc/pi-zentui) for the initial inspiration, and, of course, [`OpenCode`](https://github.com/anomalyco/opencode))
